...
public:
	...
	void add_creep(std::string creep_name, double health, std::string texture_name, double scale, double speed, double turn_speed = 5, Vector3d color = Vector3d(1,0,0),std::string _SpawnOnDeath = "", std::string _SpawnPeriodic = "", double _PeriodicSpawnRate = 1000, double _PeriodicSpawnNum = 0, double _OnDeathSpawnNum = 0);
