...
//  Error utility
//----------------------------------------------------------------------
void RGBpixmap::RGBerror(const std::string& msg, bool fatal) const
{
    if (fatal) {
...
//      power of 2.
//----------------------------------------------------------------------
bool RGBpixmap::readBMPFile(const std::string& fname, bool glPad, bool verbose)
{
    BMPHead h;                                  // file header
                                                // open file for reading
    bmpIn = new std::ifstream(fname.c_str(), std::ios::in|std::ios::binary);
    if (bmpIn == NULL || !(*bmpIn)) {
...
bool RGBpixmap::writeBMPFile(const std::string& fname) {
                                                // open file for writing
    bmpOut = new std::ofstream(fname.c_str(), std::ios::out|std::ios::binary);
